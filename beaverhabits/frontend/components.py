...
class HabitCheckBox(ui.checkbox):
    def __init__(self, habit: HabitAddCard, day: datetime.date, text: str = '', *, value: bool = False) -> None:
...
class HabitNameInput(ui.input):
    def __init__(self, habit: HabitAddCard) -> None:
...
class HabitStarCheckbox(ui.checkbox):
    def __init__(self, habit: HabitAddCard, refresh: Callable) -> None:
...
class HabitDeleteButton(ui.button):
    def __init__(self, habit: HabitAddCard, habit_list: HabitList, refresh: Callable) -> None:
...
class HabitDateInput(ui.date):
    def __init__(self, today: datetime.date, habit: HabitAddCard, ticked_data: dict[datetime.date, bool]) -> None:
        self.today = today
        self.habit = habit
...
class CalendarCheckBox(ui.checkbox):
    def __init__(self, habit: HabitAddCard, day: datetime.date, today: datetime.date, ticked_data: dict[datetime.date, bool], is_bind_data: bool = True) -> None:
        self.habit = habit
        self.day = day
        self.today = today
        self.ticked_data = ticked_data
