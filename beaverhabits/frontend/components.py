...
@ui.draggable
class DraggableHabitCheckBox(ui.checkbox):
    def __init__(
        self,
        habit: Habit,
        day: datetime.date,
...
@ui.draggable
class DraggableHabitStarCheckbox(ui.checkbox):
...
@ui.draggable
class DraggableCalendarCheckBox(ui.checkbox):
    def __init__(
        self,
        habit: Habit,
        day: datetime.date,
        ...
        with ui.row(wrap=False).classes("gap-0"):
            for day in weekday_days:
                if day <= habit_calendar.today:
                    DraggableCalendarCheckBox(habit, day, today, ticked_data, is_bind_data)
                else:
