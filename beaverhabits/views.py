...
def get_user_habit_list(user: User) -> HabitList | None:
    return user_storage.get_user_habit_list(user)


def get_user_habit(user: User, habit_id: str) -> Habit:
...
def export_user_habit_list(habit_list: HabitList, user_identify: str) -> None:
    # json to binary
